...
class AboutAsPage:
    ...
    def is_support_chat_modal_visible(self, bool):
        with allure.step('Check support chat opened or closed'):
            if bool == True:
    ...
    def close_support_chat_modal(self):
        with allure.step('Close support chat'):
